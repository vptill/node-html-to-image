...
function nodeHtmlToImage(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { html, encoding, transparent, content, output, selector, type, quality, clip, puppeteerArgs = {}, timeout = 30000, puppeteer = undefined, } = options;
        const cluster = yield puppeteer_cluster_1.Cluster.launch({
            concurrency: puppeteer_cluster_1.Cluster.CONCURRENCY_CONTEXT,
            maxConcurrency: 2,
            timeout,
            puppeteerOptions: Object.assign(Object.assign({}, puppeteerArgs), { headless: 'new' }),
            puppeteer: puppeteer,
        });
        ...
        try {
            const screenshots = yield Promise.all(contents.map((content) => {
                ...
                return cluster.execute({
                    ...
                    quality,
                    clip
                }, (_a) => __awaiter(this, [_a], void 0, function* ({ page, data }) {
