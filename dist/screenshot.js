...
function makeScreenshot(page_1, _a) {
    return __awaiter(this, arguments, void 0, function* (page, { screenshot, beforeScreenshot, waitUntil = "networkidle0", timeout, handlebarsHelpers, }) {
